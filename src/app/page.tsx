...
import { ProductForm } from "../components/product-form-dynamic";
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Add Marketplace Note */}
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <h3 className="text-sm font-medium text-blue-800 mb-2">💡 Dynamic Marketplace Support</h3>
          <p className="text-sm text-blue-700">
            You can now add products from any marketplace! Simply type the marketplace name when adding a new product.
            The system will automatically track all entered marketplaces.
          </p>
        </div>
